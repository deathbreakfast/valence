...
Binary CLI for synthetic Valence throughput experiments (`bm-v0`..`bm-v29`). Highlights: [PERFORMANCE.md](PERFORMANCE.md). Full experiment registry and AWS baselines come from AWS campaign runs.
